...
class Tello_Pose:
    def __init__(self):
        ...
        # todo change 4: add new model to recognize everything
    ...
    # todo add 1: detect_v1 use new GoogleNet model----v1_net
    ...
    def detect_v1(self, frame):
        ...
        # cmd 为识别结果，具体标签请查看model/googlenet/synset_words.txt
        cmd=classes[idx]

        print("cll",idx,classes[idx],preds[0][idx] * 100 , cmd)
        return cmd
