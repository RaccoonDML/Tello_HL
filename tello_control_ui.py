...
class TelloUI:
    ...
    def __init__(self, tello, outputpath):
        ...
        # todo dml_change 3: set if draw skeleton
    ...
    def videoLoop(self):
        ...
        try:
            ...
            # todo dml_change 4: set sleep time
            time.sleep(2)
            ...
            while not self.stopEvent.is_set():
                ...
                # todo dml_change 5 : adjust move distance
    ...
    def _autoTakeoff(self):
        ...
        # todo dml_change 1: set max time out
        ...
        # calculate the height of tello
            ...
            # todo dml_change 2: calcute the ave height
            for i in range(0, 10):
                time.sleep(0.5)
